...
import mpn from "../../../../public/assets/imgs/mpn.png";
const SobreMi = () => {
      ...
      <div className={styles.aboutMeLayout}>
        <div className={styles.aboutMeInfo}>
          ...
          <h3>
            ...
            Siempre pensando en el usuario como principal protagonista lo cual
            me motiva a enfrentar nuevos desafíos con creatividad y empatía.
            Además, de diseñadora, comparto mis conocimientos a través de la
            docencia. Me encanta dar clases y guiar a estudiantes en el mundo
            del diseño. ¡Bienvenidos!
          </h3>
          <div style={{ width: "100%" }}>
                ...
                >
                  <div className={styles.menuContent}>
                    ...
                    <p>
                      ...
                      servicios no sean solo funcionales sino también
                      proporcionen una experiencia altamente positiva y
        ...
        <div className={styles.aboutMeInfo}>
          <img src={mpn} alt="Maria Paz Navarro" />
        </div>
      </div>
    </div>
  );
